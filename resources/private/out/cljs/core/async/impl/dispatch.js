...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_22484 = (0);while(true){
var m_22485 = cljs.core.async.impl.dispatch.tasks.pop();if((m_22485 == null))
{} else
{m_22485.call(null);
if((count_22484 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__22486 = (count_22484 + (1));
count_22484 = G__22486;
continue;
}
} else
{}
