...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_22391 = (0);while(true){
if((i_22391 < arr.length))
{(arr[i_22391] = null);
{
var G__22392 = (i_22391 + (1));
i_22391 = G__22392;
continue;
}
} else
...
{var i_22398 = (self__.level + (1));while(true){
if((i_22398 <= (new_level + (1))))
{(update[i_22398] = self__.header);
{
var G__22399 = (i_22398 + (1));
i_22398 = G__22399;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_22400 = (0);while(true){
if((i_22400 <= self__.level))
{var links_22401 = (update[i_22400]).forward;if(((links_22401[i_22400]) === x__$1))
{(links_22401[i_22400] = (x__$1.forward[i_22400]));
{
var G__22402 = (i_22400 + (1));
i_22400 = G__22402;
continue;
}
} else
{{
var G__22403 = (i_22400 + (1));
i_22400 = G__22403;
continue;
}
}
