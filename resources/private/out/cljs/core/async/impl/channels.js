...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t22490 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t22490 = (function (val,box,meta22491){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t22490.cljs$lang$type = true;
cljs.core.async.impl.channels.t22490.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t22490";
cljs.core.async.impl.channels.t22490.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"cljs.core.async.impl.channels/t22490");
});
cljs.core.async.impl.channels.t22490.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t22490.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22492){var self__ = this;
var _22492__$1 = this;return self__.meta22491;
});
cljs.core.async.impl.channels.t22490.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22492,meta22491__$1){var self__ = this;
var _22492__$1 = this;return (new cljs.core.async.impl.channels.t22490(self__.val,self__.box,meta22491__$1));
});
cljs.core.async.impl.channels.__GT_t22490 = (function __GT_t22490(val__$1,box__$1,meta22491){return (new cljs.core.async.impl.channels.t22490(val__$1,box__$1,meta22491));
});
}
return (new cljs.core.async.impl.channels.t22490(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_22493 = self__.takes.pop();if((taker_22493 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_22493))
{var take_cb_22494 = cljs.core.async.impl.protocols.commit.call(null,taker_22493);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_22494,taker_22493,this$__$1){
return (function (){return take_cb_22494.call(null,null);
});})(take_cb_22494,taker_22493,this$__$1))
);
} else
{}
{
