...
{{
var G__19744 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19744;
continue;
}
} else
...
{var pred__19748 = cljs.core._EQ_;var expr__19749 = limit;if(cljs.core.truth_(pred__19748.call(null,(1),expr__19749)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__19748.call(null,(2),expr__19749)))
...
var G__19751 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19752 = (limit__$1 - (1));
var G__19753 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__19751;
limit__$1 = G__19752;
parts = G__19753;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___19755 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___19755))
{var replacement_19756 = temp__4124__auto___19755;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_19756)));
} else
{buffer.append(ch);
}
{
var G__19757 = (index + (1));
index = G__19757;
continue;
}
}
